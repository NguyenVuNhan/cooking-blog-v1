...
const GeneralInput = ({ register, control, errors, courses, image }) => {
      ...
      <Grid container item sm={5} alignItems="flex-start" spacing={2}>
        ...
        <Grid item xs={7}>
          <TextField
            ...
            helperText={!isEmpty(errors.course) ? errors.course : ""}
          >
        ...
        <Grid item xs={5}>
          <TextField
            ...
            helperText={!isEmpty(errors.duration) ? errors.duration : ""}
          />
        </Grid>
      </Grid>
            ...
            >
              <Grid item xs={7}>
                <TextField
                  ...
                  helperText={
                    !isEmpty(errors.ingredients) ? errors.ingredients : ""
                  }
                />
              </Grid>
              <Grid item xs={4}>
